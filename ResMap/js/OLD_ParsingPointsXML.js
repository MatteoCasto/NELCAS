function parsingPointsXML(jsonRes) {
    ...
    */
    ...
    let pointList = jsonRes['fusionResults']['points']['point']



    // // Séparation et listage des id des points nouveau (variables)
    // let variablePoints = xmlDoc.getElementsByTagName("variablePoints")[0];
    ...
    // ici, par défaut, on n'affiche pas les no de points
